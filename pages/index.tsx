...
export default function Index() {
    ...
    return (
        <Head>
            ...
            <meta property="og:image" content={`https://crowd-temp.vercel.app/api/temp/leith-theatres-big-radiator-generator/light/static/1146x600?${Math.random().toString().split('.')[1]}`}></meta>
