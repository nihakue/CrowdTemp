...
export function Thermometer({progress=1, progressLabel="", milestones=[.25, .50, 1], labels=['15k', '30k', '45k']}) {
    ...
    return (
        <svg style={{position: 'absolute', top: 0, left: 0, width: '100%', height: '100%'}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 130 130" preserveAspectRatio="xMidYMid meet">
            <mask id="mask2">
                <rect x="0" y="0" width="100%" height="100%" fill="black"></rect>
                <path d="M65,120.571999 q-.59,0 -1.185,-.033 a21.349,21.349 0 0 1 -19.879,-20.806 a21.1,21.1 0 0 1 10.293,-19.354 l3.89,-1.788 v-65.782 a4.881,4.881 0 1 1 11.762,0 v65.782 l3.89,1.788 a21.052,21.052 0 0 1 -8.771,40.193 " fill="white"></path>
                <Milestone complete={false} isProgressMilestone label={""} milestone={progress} distance={distance} topY={topY} color={'black'} />
            </mask>
            <path d="M76.059998,74.059998 v-61.5 a11.56,11.56 0 0 0 -11.56,-11.56 a11.56,11.56 0 0 0 -11.56,11.559 v61.5 a27.743,27.743 0 1 0 23.12,0 " fill="#dbe2eb" visibility="visible"></path>
